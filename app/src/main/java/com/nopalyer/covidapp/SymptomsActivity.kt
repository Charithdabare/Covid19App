...
class SymptomsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        symptomsList.add(Model(R.drawable.cough,"Dry Cough","This cough has a consistent tone because it is free from the sound of mucus."))
        ...
        symptomsList.add(Model(R.drawable.sore_throat,"Sore Throat","5-10%of COVID patients will have this.Usually,they will have a touch of fever,loss of taste."))
